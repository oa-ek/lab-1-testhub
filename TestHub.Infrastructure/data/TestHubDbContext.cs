...
public partial class TestHubDbContext : DbContext, IDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Answer>(entity =>
        {
            ...
            entity.HasIndex(e => e.ImageUrl, "UQ__Answer__3294EFD547D97E91");
        ...
        modelBuilder.Entity<StatusSessionQuestion>(entity =>
        {
            ...
            entity.Property(e => e.Id).ValueGeneratedOnAdd();
            entity.Property(e => e.Correct).HasColumnName("isCorrect");
            entity.Property(e => e.QuestionId).HasColumnName("QuestionID");

            entity.HasOne(d=> d.Questions).WithMany(p=>p.StatusSessionQuestions)
                .HasForeignKey(d => d.QuestionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_StatusSessionQuestion_Question");

            entity.HasOne(d => d.TestSession).WithMany(p => p.StatusSessionQuestions)
